var dados = [
    ['07h00-08h00', '', '', '', '', '', '', '303'],
    ['08h00-08h50', 'INFERÊNCIA', '', 'INFERÊNCIA', 'INTRO A COMPUTAÇAO - TA - P', 'INTRO A COMPUTAÇAO - TB - P', '', '303'],
    ['08h50-09h40', 'INFERÊNCIA', '', 'INFERÊNCIA', 'INTRO A COMPUTAÇAO - TA - P', 'INTRO A COMPUTAÇAO - TB - P', '', '303'],
    ['10h00-10h50', '', '', '', 'INTRO A COMPUTAÇAO - TB - P', '', '', '303'],
    ['10h50-11h40', '', '', '', 'INTRO A COMPUTAÇAO - TB - P', '', '', '303'],
    ['12h00-13h00', '', '', '', '', '', '', '303'],
    ['13h10-14h00', 'INTRO A COMPUTAÇAO - TC -T', 'INTRO A COMPUTAÇAO - TA - P', 'INTRO A COMPUTAÇAO - TC -T', '', '', '', '303'],
    ['14h00-14h50', 'INTRO A COMPUTAÇAO - TC -T', 'INTRO A COMPUTAÇAO - TA - P', 'INTRO A COMPUTAÇAO - TC -T', '', '', '', '303'],
    ['15h00-16h00', 'INTRO A COMPUTAÇAO - TD - T', 'INTRO A COMPUTAÇAO - TB - P', 'INTRO A COMPUTAÇAO - TD - T', '', '', '', '303'],
    ['16h00-16h50', 'INTRO A COMPUTAÇAO - TD - T', 'INTRO A COMPUTAÇAO - TB - P', 'INTRO A COMPUTAÇAO - TD - T', '', '', '', '303'],
    ['16h50-17h40', '', '', '', '', '', '', '303'],
    ['18h00-18h50', '', '', '', '', '', '', '303'],
    ['07h00-08h00', '', '', '', '', '', '', '304'],
    ...
    ['12h00-13h00', '', '', '', '', '', '', '109'],
    ['13h10-14h00', '', 'Projeto de Estradas - OBG', '', 'DESENHO TECNICO - EP - TD', '', '', '109'],
    ['14h00-14h50', '', 'Projeto de Estradas - OBG', '', 'DESENHO TECNICO - EP - TD', '', '', '109'],
    ...
    ['18h00-18h50', '', '', '', '', '', '', '404'],
    ['07h00-08h00', '', '', '', '', '', '', '503A'],
    ['08h00-08h50', '', '', '', 'REUNIAO COLEGIADO PROD', '', '', '503A'],
    ['08h50-09h40', '', '', '', 'REUNIAO COLEGIADO PROD', '', '', '503A'],
    ['10h00-10h50', 'Optativa Logística', 'Gestão da Qualidade', '', 'REUNIAO COLEGIADO PROD', '', '', '503A'],
    ['10h50-11h40', 'Optativa Logística', 'Gestão da Qualidade', '', '', '', '', '503A'],
    ['12h00-13h00', '', '', '', '', '', '', '503A'],
    ...
    ['13h10-14h00', '', '', '', '', 'ÉTICA E SOCIOLOGIA - TA - PM', '', '102'],
    ['14h00-14h50', '', '', '', '', 'ÉTICA E SOCIOLOGIA - TA - PM', '', '102'],
    ['15h00-16h00', '', '', '', '', 'ÉTICA E SOCIOLOGIA - TA - T', '', '102'],
    ['16h00-16h50', '', '', '', '', 'ÉTICA E SOCIOLOGIA - TA - T', '', '102'],
    ['16h50-17h40', '', '', '', '', '', '', '102'],
    ['18h00-18h50', '', '', '', '', '', '', '102'],
    ['07h00-08h00', '', '', '', '', '', '', '202'],
    ...
    ['12h00-13h00', '', '', '', '', '', '', '202'],
    ['13h10-14h00', 'Sustentabilidade', '', 'INTRODUÇÃO À TRIBOLOGIA', '', '', '', '202'],
    ['14h00-14h50', 'Sustentabilidade', '', 'INTRODUÇÃO À TRIBOLOGIA', '', '', '', '202'],
    ...
    ['18h00-18h50', '', '', '', '', '', '', '108'],
    ['07h00-08h00', '', '', '', '', '', '', '208'],
    ['08h00-08h50', 'PROBABILIDADE E ESTATISTICA - PT', '', 'PROBABILIDADE E ESTATISTICA - PT', '', 'Metrologia', '', '208'],
    ['08h50-09h40', 'PROBABILIDADE E ESTATISTICA - PT', '', 'PROBABILIDADE E ESTATISTICA - PT', '', 'Metrologia', '', '208'],
    ...
    ['18h00-18h50', '', '', '', '', '', '', '208'],
    ['07h00-08h00', '', '', '', '', '', '', '308'],
    ['08h00-08h50', 'CIENCIA DOS MATERIAIS 2', '', 'CIENCIA DOS MATERIAIS 2', '', 'Introdução a Eng de Produção', '', '308'],
    ['08h50-09h40', 'CIENCIA DOS MATERIAIS 2', '', 'CIENCIA DOS MATERIAIS 2', '', 'Introdução a Eng de Produção', '', '308'],
    ...
    ['15h00-16h00', '', 'Geografia, Transporte e Sociedade - OBG', '', '', '', '', '308'],
    ['16h00-16h50', '', 'Geografia, Transporte e Sociedade - OBG', '', '', '', '', '308'],
    ['16h50-17h40', '', '', '', '', '', '', '308'],
    ['18h00-18h50', '', '', '', '', '', '', '308'],
    ['07h00-08h00', '', '', '', '', '', '', '504'],
    ...
    ['12h00-13h00', '', '', '', '', '', '', '504'],
    ['13h10-14h00', 'Processos Sedimentares', 'Organização do Trabalho ', 'Empreendedorismo', '', 'SAÚDE E SEGURANÇA NO TRABALHO', '', '504'],
    ['14h00-14h50', 'Processos Sedimentares', 'Organização do Trabalho ', 'Empreendedorismo', '', 'SAÚDE E SEGURANÇA NO TRABALHO', '', '504'],
    ['15h00-16h00', 'Petrologia Ígnea', 'Organização do Trabalho ', 'Introdução à Economia', '', 'Introdução à Economia', '', '504'],
    ['16h00-16h50', 'Petrologia Ígnea', 'Organização do Trabalho ', 'Introdução à Economia', '', 'Introdução à Economia', '', '504'],
    ['16h50-17h40', '', '', '', '', '', '', '504'],
    ['18h00-18h50', '', '', '', '', '', '', '504'],
    ['07h00-08h00', '', '', '', '', '', '', '505'],
    ...
    ['10h50-11h40', 'Sustentabilidade', 'Gestão da Qualidade', 'Transporte e Meio Ambiente 1 - OBG', '', 'Ergonomia e Engenharia no Trabalho', '', '506'],
    ['12h00-13h00', 'Sustentabilidade', '', '', '', '', '', '506'],
    ...
    ['15h00-16h00', 'Introdução à Engenharia da Materiais', 'Aspectos Econômicos do Transporte - OBG', 'Ciências do Ambiente', 'Transporte e Desenvolvimento - OPT', 'Operação de Sistemas de transportes 1 - OBG', '', '506'],
    ['16h00-16h50', 'Introdução à Engenharia da Materiais', 'Aspectos Econômicos do Transporte - OBG', 'Ciências do Ambiente', 'Transporte e Desenvolvimento - OPT', 'Operação de Sistemas de transportes 1  - OBG', '', '506'],
    ['16h50-17h40', '', '', '', '', '', '', '506'],
    ['18h00-18h50', '', '', '', '', '', '', '506'],
    ['07h00-08h00', '', '', '', '', '', '', '507'],
    ['08h00-08h50', 'P. M. Cerâmicos', 'Projeto de Ferrovias - OBG', 'P. M. Cerâmicos', 'Engenharia Econômica', 'P. M. Metálicos', '', '507'],
    ['08h50-09h40', 'P. M. Cerâmicos', 'Projeto de Ferrovias - OBG', 'P. M. Cerâmicos', 'Engenharia Econômica', 'P. M. Metálicos', '', '507'],
